...
¡No pierdas esta oportunidad!`;
                    ...
                    className="bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-6 rounded-2xl text-sm shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 inline-flex items-center gap-2"
                  >
