...
¡No pierdas esta oportunidad!`;
  ...
  return <section className="py-20 bg-gradient-to-br from-bestart-light to-bestart-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <div className="flex items-center justify-center gap-3 mb-6">
              <div className="bg-bestart-dark rounded-xl px-4 py-2">
                <img src="/bestart-logo-complete.png" alt="Bestart" className="h-8 w-auto brightness-0 invert" />
              </div>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-bestart-dark mb-6">CONTÁCTANOS</h2>
          ...
          <div className="flex justify-center">
            <Button onClick={handleWhatsAppClick} className="bg-green-500 hover:bg-green-600 text-white font-bold py-6 px-8 sm:px-12 rounded-2xl text-lg sm:text-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 inline-flex items-center gap-3 sm:gap-4">
